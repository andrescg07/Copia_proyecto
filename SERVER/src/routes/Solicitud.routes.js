...
router.get('/listarSolicitudes',Autorizacion.verificarToken, SolicitudesCtrl.listar)
router.get('/listar/:id', Autorizacion.verificarToken, SolicitudesCtrl.listarId)
